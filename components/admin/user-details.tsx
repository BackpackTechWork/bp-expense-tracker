...
export function UserDetails({ user }: UserDetailsProps) {
  const totalExpenseAmount = user.expenses.reduce((sum, expense) => sum + expense.amount, 0)
    ...
    <div className="space-y-6">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-lg">{format(new Date(user.createdAt), "MMM dd, yyyy")}</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-2xl font-bold">${totalExpenseAmount.toFixed(2)}</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
          ...
          <CardContent>
            <p className="text-2xl font-bold">{user._count.activityLogs}</p>
          </CardContent>
        </Card>
      </div>
