    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Manage and filter your expenses</p>
        </div>
      </div>

      <ExpenseList expenses={expenses} categories={categories} pagination={pagination} searchParams={searchParams} />
    </div>
  )
}
