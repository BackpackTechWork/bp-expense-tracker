...
export default async function AnalyticsPage() {
  ...
  const [currentMonthExpenses, lastMonthExpenses, categoryData, last6MonthsData, dailyData] = await Promise.all([
  ...
  const stats = {
    ...
    averageTransaction: currentMonthExpenses.length > 0 ? currentMonthTotal / currentMonthExpenses.length : 0,
  }
