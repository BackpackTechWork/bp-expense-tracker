            ...
            <section className="py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
                        Track Your Expenses
                        <span className="block text-[#DC143C]">
                            Anywhere, Anytime
                        </span>
                    </h1>
                    <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                        A powerful PWA expense tracker that works offline.
                        Manage your finances with beautiful charts, smart
                        budgeting, and seamless synchronization across all your
                        devices.
                    </p>
                    <div className="space-x-4">
                        <Button
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-600">
                            Powerful features designed for modern expense
                            tracking
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        <Card className="bg-white/80 backdrop-blur-sm border-white/20">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Add expenses even without internet.
                        ...
                        <Card className="bg-white/80 backdrop-blur-sm border-white/20">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Beautiful charts and insights to understand
                        ...
                        <Card className="bg-white/80 backdrop-blur-sm border-white/20">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Your financial data is encrypted and stored
                                    securely with enterprise-grade security.
                                </CardDescription>
                            </CardHeader>
                        </Card>
                        ...
                        <Card className="bg-white/80 backdrop-blur-sm border-white/20">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Optimized for speed with instant loading and
                                    smooth animations.
                                </CardDescription>
                            </CardHeader>
                        </Card>
            ...
            <footer className="bg-white/90 backdrop-blur-sm border-t border-white/20 py-8">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <p className="text-gray-600">
                        © 2024 ExpenseTracker. Built with Next.js and love.
                    </p>
                </div>
            </footer>
        </div>
